...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
  ...
  public void publish(OrderApprovedEvent domainEvent) {
    ...
    try {
      var topicName = configData.restaurantApprovalResponseTopicName();
      var topicMessage = mapper.orderApprovedEventToRestaurantApprovalResponseAvroModel(
          domainEvent);

      kafkaProducer.send(topicName, orderId, topicMessage,
          helper.getHandler(topicName, topicMessage, orderId,
